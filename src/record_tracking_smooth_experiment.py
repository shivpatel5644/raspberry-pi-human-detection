...
video_path = os.path.join(OUTPUT_DIR, f"smooth_tracking_experiment_{timestamp}.mp4")
log_path = os.path.join(LOG_DIR, f"smooth_tracking_experiment_{timestamp}.csv")
...
print("Smooth tracking recording started. Press q to quit.")
...
try:
    with open(log_path, "w", newline="") as f:
        ...
        while True:
            ...
            cv2.imshow("Smooth Tracking Recording", img)
