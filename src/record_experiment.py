...
video_path = os.path.join(OUTPUT_DIR, f"experiment_{timestamp}.mp4")
log_path = os.path.join(LOG_DIR, f"experiment_{timestamp}.csv")
...
print("Experiment recording started. Press 'q' to quit.")
...
try:
    with open(log_path, "w", newline="") as f:
        ...
        while True:
            ...
            boxes, scores, class_ids = parse_yolo_output(out_net, frame_w, frame_h)
            ...
            out.write(img)
            cv2.imshow("Recording Experiment", img)
