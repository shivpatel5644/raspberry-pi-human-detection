...
print("Segmentation demo started. Press q to quit.")
...
try:
    while True:
        ...
        det = np.squeeze(det_out)
        proto = np.squeeze(proto_out)
        ...
        cv2.imshow("YOLOv8 Segmentation Demo", overlay)
        #cv2.resizeWindow("Segmentation", 800, 600)
    ...
    print("Segmentation demo stopped.")
