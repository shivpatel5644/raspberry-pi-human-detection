...
def generate_frames():
    global locked_target_center, lost_frames
    ...
    while True:
        ...
        cv2.putText(img, f"Command: {command}", (10, 55),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
        cv2.putText(img, f"Steering: {steering_text}", (10, 85),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 0), 2)
        cv2.putText(img, f"Distance ratio: {distance_ratio_text}", (10, 115),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.65, (200, 255, 200), 2)
        cv2.putText(img, f"Lock status: {lock_status}", (10, 145),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.65, (255, 200, 200), 2)
...
if __name__ == "__main__":
    print("Starting browser stream on port 5000...")
