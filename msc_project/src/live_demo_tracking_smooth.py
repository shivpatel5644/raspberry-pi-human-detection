...
# Distance thresholds based on person box area / frame area
TOO_FAR_RATIO = 0.03
TOO_CLOSE_RATIO = 0.90
...
print("Smooth tracking demo started. Press q to quit.")
...
try:
    while True:
        ...
        cv2.imshow("YOLOv8 Smooth Tracking Demo", img)
    ...
    print("Smooth tracking demo stopped.")
